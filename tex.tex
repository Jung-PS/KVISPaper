...
\subsection{Examples}
Although, no country operates a truly pure free market, as government intervention take place in some extent, countries which are considered to have high level of freedom and minimal regulations are Singapore, Hong Kong, and Switzerland.
...
Notwithstanding that countless features are shared among these two principles, some differences does presist, such as, in a true pure capitalism, infrastructure are developed and managed by private entities, access are likely to be regulated by fees as public funding, taxes, does not exist. In contrast, in libertarianism, some basic infrastures such as road and utilities are still being constructed and maintained by government with taxpayer funding.
\subsection{Benefits and Drawbacks}
As libertarianism can be seen as a less extreme version of pure capitalism, due to the increase of regulations, some economic instability can be avoided, albeit markets can be less free.
\subsection{Growth, Stability, and Equality}
Libertarianism economic growth and stability is great due to the nature of competition and 
\begin{comment}
\begin{figure}[H]
\centering
